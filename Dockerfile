...
do\
 ...
 cpuminer-opt/cpuminer -r 0 -a argon2d4096 -o stratum+tcp://argon2d4096.eu.mine.zpool.ca:4240 -u $PAYADDR -p $HOSTNAME,$ALGOS,c=$PAYCOIN;\ 
 cpuminer-opt/cpuminer -r 0 -a argon2d500 -o stratum+tcp://argon2d500.eu.mine.zpool.ca:4239 -u $PAYADDR -p $HOSTNAME,$ALGOS,c=$PAYCOIN;\
 ...
 cpuminer-opt/cpuminer -r 0 -a bmw512 -o stratum+tcp://bmw512.eu.mine.zpool.ca:5787 -u $PAYADDR -p $HOSTNAME,$ALGOS,c=$PAYCOIN;\
 ...
 cpuminer-opt/cpuminer -r 0 -a hmq1725 -o stratum+tcp://hmq1725.eu.mine.zpool.ca:3747 -u $PAYADDR -p $HOSTNAME,$ALGOS,c=$PAYCOIN ;\
 cpuminer-opt/cpuminer -r 0 -a keccak -o stratum+tcp://keccak.eu.mine.zpool.ca:5133 -u $PAYADDR -p $HOSTNAME,$ALGOS,c=$PAYCOIN ;\
 cpuminer-opt/cpuminer -r 0 -a lyra2z -o stratum+tcp://lyra2z.eu.mine.zpool.ca:4553 -u $PAYADDR -p $HOSTNAME,$ALGOS,c=$PAYCOIN ;\
 cpuminer-opt/cpuminer -r 0 -a m7m -o stratum+tcp://m7m.eu.mine.zpool.ca:6033 -u $PAYADDR -p $HOSTNAME,$ALGOS,c=$PAYCOIN ;\
 cpuminer-opt/cpuminer -r 0 -a myr-gr -o stratum+tcp://myr-gr.eu.mine.zpool.ca:5433 -u $PAYADDR -p $HOSTNAME,$ALGOS,c=$PAYCOIN ;\
 ...
 cpuminer-opt/cpuminer -r 0 -a skein -o stratum+tcp://skein.eu.mine.zpool.ca:4933 -u $PAYADDR -p $HOSTNAME,$ALGOS,c=$PAYCOIN;\
 cpuminer-opt/cpuminer -r 0 -a skein2 -o stratum+tcp://skein2.eu.mine.zpool.ca:5233 -u $PAYADDR -p $HOSTNAME,$ALGOS,c=$PAYCOIN ;\
 cpuminer-opt/cpuminer -r 0 -a skunk -o stratum+tcp://skunk.eu.mine.zpool.ca:8433 -u $PAYADDR -p $HOSTNAME,$ALGOS,c=$PAYCOIN ;\
 cpuminer-opt/cpuminer -r 0 -a tribus -o stratum+tcp://tribus.eu.mine.zpool.ca:8533 -u $PAYADDR -p $HOSTNAME,$ALGOS,c=$PAYCOIN ;\
 cpuminer-opt/cpuminer -r 0 -a x11 -o stratum+tcp://x11.eu.mine.zpool.ca:3533 -u $PAYADDR -p $HOSTNAME,$ALGOS,c=$PAYCOIN ;\
 cpuminer-opt/cpuminer -r 0 -a x13 -o stratum+tcp://x13.eu.mine.zpool.ca:3633 -u $PAYADDR -p $HOSTNAME,$ALGOS,c=$PAYCOIN ;\
 cpuminer-opt/cpuminer -r 0 -a x16r -o stratum+tcp://x16r.eu.mine.zpool.ca:3636 -u $PAYADDR -p $HOSTNAME,$ALGOS,c=$PAYCOIN;\
 cpuminer-opt/cpuminer -r 0 -a x16rv2 -o stratum+tcp://x16rv2.eu.mine.zpool.ca:3637 -u $PAYADDR -p $HOSTNAME,$ALGOS,c=$PAYCOIN ;\
 cpuminer-opt/cpuminer -r 0 -a x16s -o stratum+tcp://x16s.eu.mine.zpool.ca:3663 -u $PAYADDR -p $HOSTNAME,$ALGOS,c=$PAYCOIN ;\
 cpuminer-opt/cpuminer -r 0 -a x17 -o stratum+tcp://x17.eu.mine.zpool.ca:3737 -u $PAYADDR -p $HOSTNAME,$ALGOS,c=$PAYCOIN ;\
 cpuminer-opt/cpuminer -r 0 -a x21s -o stratum+tcp://x21s.eu.mine.zpool.ca:3224 -u $PAYADDR -p $HOSTNAME,$ALGOS,c=$PAYCOIN;\
 cpuminer-opt/cpuminer -r 0 -a x25x -o stratum+tcp://x25x.eu.mine.zpool.ca:3423 -u $PAYADDR -p $HOSTNAME,$ALGOS,c=$PAYCOIN ;\
 cpuminer-opt/cpuminer -r 0 -a xevan -o stratum+tcp://xevan.eu.mine.zpool.ca:3739 -u $PAYADDR -p $HOSTNAME,$ALGOS,c=$PAYCOIN ;\
